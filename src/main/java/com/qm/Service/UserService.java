...
import com.qm.Repository.RoleRepository;
...
import com.qm.POJO.AuthenticationResponse;
import com.qm.Payload.JwtResponse;
import com.qm.Payload.LoginRequest;
import com.qm.Payload.RegisterRequest;
...
import static com.qm.config.AppSecurityConfiguration.passwordEncoder;
...
public class UserService {
	...
	public ResponseEntity<?> authenticateUser(LoginRequest loginRequest) {
		...
		try {
//			authentication = AuthauthManager.authenticate(userPassAuth);
//			SecurityContextHolder.getContext().setAuthentication(authentication);
			CustomUserDetails userDetails = (CustomUserDetails) service.loadUserByUsername(loginRequest.getEmail());
